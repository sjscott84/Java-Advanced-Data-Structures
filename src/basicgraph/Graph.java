...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i = 0; i < numVertices; i++){
			...
			int numOfVertices = outNeighbors.size() + inNeighbors.size();
			degreeSequence.add(numOfVertices);
			//System.out.println(getNeighbors(i));
			//System.out.println(getInNeighbors(i));
		}
